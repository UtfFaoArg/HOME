...
var Provincia = L.geoJSON({
	...prov,
	features: prov.features.filter(f => f.properties.nam === "Misiones")
}, {
	style: SytleProv
});
...
var Localidad = L.geoJSON({
	...locCabecera,
	features: locCabecera.features.filter(f => f.properties.nom_pcia === "Misiones")
}, {
...
var Parajes = L.geoJSON({
	...locSec,
	features: locSec.features.filter(f => f.properties.nom_pcia === "Misiones")
}, {
...
var DataCenso = L.geoJSON({
	...censo,
	features: censo.features.filter(f => f.properties.provincia === "Misiones")
}, {
	style: styleCenso,
...
var POBIndigena = L.geoJSON({
	...pobInd,
	features: pobInd.features.filter(f => f.properties.prov_com === "Misiones")
}, {
...
var NBI = L.geoJSON({
	...nbi,
	features: nbi.features.filter(f => f.properties.PROV === "Misiones")
}, {
	style: styleNBI,
...
var AguaRED = L.geoJSON({
	...aguaRed,
	features: aguaRed.features.filter(f => f.properties.PROV === "Misiones")
}, {
	style: styleAguaRed,
...
var NucleosAF = L.geoJSON({
	...naf,
	features: naf.features.filter(f => f.properties.provincia === "Misiones")
}, {
	style: styleNAG,
...
var ProyecAgua = L.geoJSON({
	...proyectos,
	features: proyectos.features.filter(f => f.properties.PROVINCIA === "MISIONES")
}, {
...
var PuntosAgri = L.geoJSON({
	...agri,
	features: agri.features.filter(f => f.properties.Admin_2 === "Misiones")
}, {
...
var EstacionesSMN = L.geoJSON({
	...SMN,
	features: SMN.features.filter(f => f.properties.PROVINCIA === "MISIONES")
}, {
...
var SuelosTipo = L.geoJSON({
	...suelos,
	features: suelos.features.filter(f => f.properties.provincia === "MISIONES")
}, {
		style: styleSuelos,
...
var DeptoArsenico = L.geoJSON({
	...dptoArsenico,
		features: dptoArsenico.features.filter(f => f.properties.provincia === "Misiones")
}, {
...
var ModelosTotal = L.geoJSON({
	...datamodelo,
	features: datamodelo.features.filter(f => f.properties.Provincia === "Misiones")
}, {
...
var ModelosProductivo = L.geoJSON({
  ...
  features: datamodeloProductivo.features.filter(f => f.properties.Provincia === "Misiones")
}, {
