...
var Provincia = L.geoJSON({
	...prov,
	features: prov.features.filter(f => f.properties.nam === "Formosa")
}, {
	style: SytleProv
});
...
var Localidad = L.geoJSON({
	...locCabecera,
	features: locCabecera.features.filter(f => f.properties.nom_pcia === "Formosa")
}, {
...
var Parajes = L.geoJSON({
	...locSec,
	features: locSec.features.filter(f => f.properties.nom_pcia === "Formosa")
}, {
...
var DataCenso = L.geoJSON({
	...censo,
	features: censo.features.filter(f => f.properties.provincia === "Formosa")
}, {
	style: styleCenso,
...
var POBIndigena = L.geoJSON({
	...pobInd,
	features: pobInd.features.filter(f => f.properties.prov_com === "Formosa")
}, {
...
var NBI = L.geoJSON({
	...nbi,
	features: nbi.features.filter(f => f.properties.PROV === "Formosa")
}, {
	style: styleNBI,
...
var AguaRED = L.geoJSON({
	...aguaRed,
	features: aguaRed.features.filter(f => f.properties.PROV === "Formosa")
}, {
	style: styleAguaRed,
...
var ProyecAgua = L.geoJSON({
	...proyectos,
	features: proyectos.features.filter(f => f.properties.PROVINCIA === "FORMOSA")
}, {
...
var SitiosSeleccionados = L.geoJSON({
	...sitios,
	features: sitios.features.filter(f => f.properties.Provincia === "Formosa")
}, {
...
var PuntosAgri = L.geoJSON({
	...agri,
	features: agri.features.filter(f => f.properties.Admin_2 === "Formosa")
}, {
...
var EstacionesSMN = L.geoJSON({
	...SMN,
	features: SMN.features.filter(f => f.properties.PROVINCIA === "FORMOSA")
}, {
...
var DeptoArsenico = L.geoJSON({
	...dptoArsenico,
		features: dptoArsenico.features.filter(f => f.properties.provincia === "Formosa")
}, {
...
var ModelosTotal = L.geoJSON({
	...datamodelo,
	features: datamodelo.features.filter(f => f.properties.Provincia === "Formosa")
}, {
